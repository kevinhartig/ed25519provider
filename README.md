# Simple example of passing messages with ComposeDB

### `npm ceramic`

Starts a local Ceramic node. Ceramic and CeramicDB must be installed to use the example.
e.g.
...
https://dev.to/fllstck/decentralized-databases-composedb-49m3
